...
namespace Flavioski\Module\ModularSofas\Domain\Modular\Configuration;

/**
 * Stores modular form constraints configuration values
 */
final class ModularConstraint
{
    /**
     * Maximum length for modular name (value is constrained by database)
     */
    public const MAX_MODULAR_NAME_LENGTH = 128;
